...
export function Home() {
  ...
  return (
    <div className="bodydiv">
      ...
      >
        <div className="how_to_join" id="apitest">HOW IT WORKS</div>
      </div>
      ...
      <div className="mobile">
        ...
        <div className="how_to_m">
          ...
          <br /> <br /><span id="displaycoins">
          Create an account now to <br />
          join the fun by pressing{" "}</span>
      ...
      <div className="steps_p">
        ...
        >
          <p id="CAC_step_p">
            Pick from one of our many categories, select the number of coins you
            want to use, and begin betting.
          </p>
        </div>
        <div
      ...
      >
        <div id="wwa_para">
          {" "}
          <p>
            Bet virtual points against your friends, whenever you want, wherever
            you want, for whatever you want. Whether your passion is in Esports
            or traditional sports, VPbetting has it all. Begin betting against
            friends now.
          </p>
        </div>
      </div>
      ...
      <div className="categs">
        ...
        >
          ...
          <Link
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + "/images/categories/c_tic-tac-toe.jpg"
              })`,
              backgroundPosition: `center`,
            }}
          >
